...
VIDEO_START_TEXT = (
    ...
    "Технология Kling v2.5 Turbo Pro превращает статичные кадры в кинематографичные видеоролики с естественной динамикой и плавными переходами.\n\n"
    "**Возможности:**\n"
    "✦ Реалистичная анимация движений и мимики\n"
    "✦ Интеллектуальная интерпретация сложных инструкций\n"
    "✦ Сохранение оригинального стиля, цветовой палитры и композиции\n"
    "✦ Поддержка движения камеры и сложных траекторий\n\n"
    "**Примеры описаний:**\n"
    "• «Человек поворачивает голову и улыбается, камера статична»\n"
    "• «Автомобиль движется по дороге, камера следует параллельно»\n"
    "• «Листва колышется от легкого ветра, естественное освещение»\n"
    "• «Человек идет по улице, камера медленно приближается»\n\n"
    "📸 **Загрузите изображение**, которое требуется анимировать."
)
