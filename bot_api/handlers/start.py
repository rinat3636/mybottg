...
HELP_TEXT = (
    ...
    "**Тарифы:**\n"
    "• Nano Banana Pro — 30 кредитов (премиум-результат)\n"
    "• Flux 2 Pro — 24 кредита (профессиональное качество)\n"
    "• Riverflow 2.0 PRO — 32 кредита (максимальная детализация)\n"
    "• Видео 5 сек — 70 кредитов\n"
    "• Видео 10 сек — 140 кредитов\n\n"
    "**Баланс и пополнение:**\n"
    "• Новым пользователям — 24 кредита в подарок\n"
    "• Реферальная программа — по 24 кредита за каждого приглашенного\n"
...
def _build_tariffs_text() -> str:
    ...
    return (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━━\n\n"
         "🎁 **Бонусная программа:**\n"
        "✦ **Новым пользователям** — 24 кредита в подарок\n"
        "✦ **Реферальная программа** — по 24 кредита за каждого приглашенного друга\n\n"
        "━━━━━━━━━━━━━━━━━━━━━━━"
    )
